    ...
    <Container>
      ...
      <div className='pl-16'>
        ...
        <Typography className="text-gray-400 pb-4">
          • view my <a className='hover:scale-105 transition-all duration-300 hover:underline text-purple-400' href="/GraceZhangBSResume_Dec23.pdf" target="_blank">resume</a>
        </Typography>
